...
{
    public class AddInstructorReviewValidator : AbstractValidator<AddInstructorReviewCommand>
    {
        #region Fields 
        ...
        #region constructor
        public AddInstructorReviewValidator(LocalizationService localization)
        {
