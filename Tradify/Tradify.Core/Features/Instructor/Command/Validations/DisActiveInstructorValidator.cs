...
{
    public class DisActiveInstructorValidator : AbstractValidator<DisActiveInstructorCommand>
    {
        ...
        #region constructor
        public DisActiveInstructorValidator(LocalizationService localization)
        {
