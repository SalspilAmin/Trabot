...
{
    public class EinvoicePayRequestValidator : AbstractValidator<EnvoicePayRequestCommand>
    {
        private readonly LocalizationService localization;
        public EinvoicePayRequestValidator(LocalizationService localization)
        {
