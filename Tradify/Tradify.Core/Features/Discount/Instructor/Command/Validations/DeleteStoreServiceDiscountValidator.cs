...
{
    public class DeleteStoreServiceDiscountValidator : AbstractValidator<DeleteStoreServiceDiscountCommand>
    {
        #region Fields 
        ...
        #region constructor
        public DeleteStoreServiceDiscountValidator(LocalizationService localization)
        {
