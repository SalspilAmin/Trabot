...
{
    public class AddInstructorDiscountValidator : AbstractValidator<AddInstructorDiscountCommand>
    {
        ...
        #region constructor
        public AddInstructorDiscountValidator(LocalizationService localization)
        {
