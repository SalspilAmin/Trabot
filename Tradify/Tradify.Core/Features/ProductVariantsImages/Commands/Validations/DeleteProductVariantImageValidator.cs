...
{
    public class DeleteProductVariantImageValidator : AbstractValidator<DeleteProductVariantImageCommand>
    {
        #region Fields 
        ...
        #region constructor
        public DeleteProductVariantImageValidator(LocalizationService localization)
        {
