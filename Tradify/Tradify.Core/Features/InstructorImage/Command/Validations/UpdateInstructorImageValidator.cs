...
{
    internal class UpdateInstructorImageValidator : AbstractValidator<UpdateInstructorImageCommand>
    {
        #region Fields 
        ...
        #region constructor
        public UpdateInstructorImageValidator(LocalizationService localization)
        {
