...
{
    /// <inheritdoc />
    public partial class FianlMig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SotreId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payouts_Sellers_SellersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserIdThatWriteAComment = table.Column<int>(type: "int", nullable: false),
                    UserIdThatWriteAReplyOFComment = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoreBookings_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreBookingId = table.Column<int>(type: "int", nullable: true),
                    StoreBookingId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_Sellers_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Sellers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_StoreBookings_StoreBookingId",
                        column: x => x.StoreBookingId,
                        principalTable: "StoreBookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_StoreBookings_StoreBookingId1",
                        column: x => x.StoreBookingId1,
                        principalTable: "StoreBookings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    FinalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "[Price] - ([Price] * [Discount] / 100)"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StoreBookingId",
                table: "Appointments",
                column: "StoreBookingId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StoreBookingId1",
                table: "Appointments",
                column: "StoreBookingId1");
